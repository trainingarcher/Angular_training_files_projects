...
var Employee = /** @class */ (function (_super) {
    ...
    Employee.prototype.describe = function () {
        return "Hi " + _super.prototype.describe.call(this) + " I am working as a " + this.jobTitle + ".";
    };
    Employee.headcount = 0;
    return Employee;
}(Person));
var employee1 = new Employee('Yogesh', 'Patel', 'Front-end Developer');
console.log(employee1.getFullName());
console.log(employee1.describe());
console.log(Employee.headcount);
var employee2 = new Employee('Dishant', 'Sharma', 'Front-end Developer');
console.log(employee2.describe());
console.log(Employee.headcount);
var employee3 = new Employee('Prudhvi', 'Krishna', 'Front-end Developer');
